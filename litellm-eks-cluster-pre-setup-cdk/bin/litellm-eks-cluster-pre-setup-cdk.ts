...
import { LitellmEksClusterPreSetupCdkStack } from '../lib/litellm-eks-cluster-pre-setup-cdk-stack';
...
new LitellmEksClusterPreSetupCdkStack(app, 'LitellmEksClusterPreSetupCdkStack', {
  vpcId: vpcId,
